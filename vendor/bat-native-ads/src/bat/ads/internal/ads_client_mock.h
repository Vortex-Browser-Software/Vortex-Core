...
#ifndef VORTEX_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_ADS_CLIENT_MOCK_H_
#define VORTEX_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_ADS_CLIENT_MOCK_H_
...
class AdsClientMock : public AdsClient {
 public:
  ...
  MOCK_METHOD1(LogTrainingInstance,
               void(const vortex_federated::mojom::TrainingInstancePtr
                        training_instance));
...
#endif  // VORTEX_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_ADS_CLIENT_MOCK_H_
