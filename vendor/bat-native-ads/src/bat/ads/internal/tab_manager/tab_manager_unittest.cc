...
TEST_F(BatAdsTabManagerTest, IsTabVisible) {
  ...
  // Act
  TabManager::Get()->OnUpdated(1, GURL("https://vortex.com"), true, false);
...
TEST_F(BatAdsTabManagerTest, IsTabOccluded) {
  ...
  // Act
  TabManager::Get()->OnUpdated(1, GURL("https://vortex.com"), false, false);
...
TEST_F(BatAdsTabManagerTest, OpenNewTab) {
  ...
  expected_tab.id = 1;
  expected_tab.url = GURL("https://vortex.com");
...
TEST_F(BatAdsTabManagerTest, DoNotUpdateIncognitoTab) {
  ...
  // Act
  TabManager::Get()->OnUpdated(1, GURL("https://vortex.com"), true, true);
...
TEST_F(BatAdsTabManagerTest, UpdateExistingOccludedTabWithDifferentUrl) {
  ...
  // Act
  TabManager::Get()->OnUpdated(1, GURL("https://vortex.com/about"), false,
                               false);
  ...
  TabInfo expected_tab;
  expected_tab.id = 1;
  expected_tab.url = GURL("https://vortex.com/about");
  expected_tab.is_playing_media = false;
  EXPECT_EQ(expected_tab, tab.value());
...
TEST_F(BatAdsTabManagerTest, UpdatedExistingTabWithDifferentUrl) {
  ...
  // Act
  TabManager::Get()->OnUpdated(1, GURL("https://vortex.com/about"), true, false);
...
TEST_F(BatAdsTabManagerTest, GetVisibleTab) {
  // Arrange
  TabManager::Get()->OnUpdated(1, GURL("https://foobar.com"), true, false);
  TabManager::Get()->OnUpdated(2, GURL("https://vortex.com"), true, false);
  ResetObserver();
