...
TEST(BatAdsServerHostUtilTest, GetStaticHost) {
  ...
  // Assert
  const std::string expected_host = "https://static.ads.vortex.com";
...
TEST(BatAdsServerHostUtilTest, GetGeoHost) {
  ...
  // Assert
  const std::string expected_host = "https://geo.ads.vortex.com";
  EXPECT_EQ(expected_host, host);
}
...
TEST(BatAdsServerHostUtilTest, GetNonAnonymousHost) {
  ...
  // Assert
  const std::string expected_host = "https://mywallet.ads.vortex.com";
  EXPECT_EQ(expected_host, host);
}
