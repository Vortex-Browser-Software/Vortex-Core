...
public class VortexFeedSurfaceCoordinator extends FeedSurfaceCoordinator {
    ...
    public VortexFeedSurfaceCoordinator(Activity activity, SnackbarManager snackbarManager,
