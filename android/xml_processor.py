...
# Copyright 2022 Vortex Browser. All rights reserved.
...
def _AddVortexPrefix(relpath):
  dirname, filename = os.path.split(relpath)
  return os.path.join(dirname, 'vortex_' + filename)
...
def _XMLTransform(source_pairs, outputs_zip):
  ...
  with build_utils.TempDir() as temp_dir:
    ...
    for source, module in source_pairs:
      ...
      relpath = _AddVortexPrefix(relpath)
