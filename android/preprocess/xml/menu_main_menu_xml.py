...
def _ProcessXML(root):
  ...
  node_str = '<item xmlns:android="http://schemas.android.com/apk/res/android" '\
    'android:id="@+id/vortex_wallet_id" ' \
    'android:title="@string/menu_vortex_wallet" ' \
  ...
  vpn_node_str = '<item xmlns:android="http://schemas.android.com/apk/res/android" '\
          'android:id="@+id/request_vortex_vpn_row_menu_id" '\
          'android:title="@null"> '\
          '<menu> '\
              '<item android:id="@+id/request_vortex_vpn_id" '\
                'android:title="@string/vortex_vpn" '\
                'android:icon="@drawable/ic_vpn" /> '\
              '<item android:id="@+id/request_vortex_vpn_check_id" '\
                'android:title="@null" '\
