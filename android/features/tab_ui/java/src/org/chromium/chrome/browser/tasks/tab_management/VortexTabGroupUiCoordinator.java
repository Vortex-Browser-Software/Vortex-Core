...
public class VortexTabGroupUiCoordinator extends TabGroupUiCoordinator {
    ...
    public VortexTabGroupUiCoordinator(@NonNull Activity activity, @NonNull ViewGroup parentView,
        ...
        if (toolbarRightButton != null) {
            toolbarRightButton.setImageResource(R.drawable.vortex_new_group_tab);
        }
    }
